...
if page == "Prestação de Contas Mensal":
    ...
    if st.session_state.get('print_mode', False):
        ...
        st.markdown("<h1 style='text-align: center; color: black; font-size: 28px; font-weight: bold; margin-bottom: 5px;'>📊 Dashboard Financeiro SantaLuz</h1>", unsafe_allow_html=True)
        ...
        if not df_receitas.empty:
            ...
            fig_rec_print.update_layout(legend=dict(orientation='v', yanchor='top', y=1, xanchor='left', x=0.50, font=dict(size=12)), margin=dict(t=10, b=10, l=0, r=0), height=350)
        ...
        if not df_despesas.empty:
            ...
            fig_desp_print.update_layout(legend=dict(orientation='v', yanchor='top', y=1, xanchor='left', x=0.50, font=dict(size=12)), margin=dict(t=10, b=10, l=0, r=0), height=350)
